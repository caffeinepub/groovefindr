...
export class Backend implements backendInterface {
    ...
    async addFavorite(arg0: Song): Promise<void> {
    ...
    async generateChordProgression(arg0: string, arg1: string): Promise<Array<Chord>> {
        if (this.processError) {
            try {
                const result = await this.actor.generateChordProgression(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getArtistDetails(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getArtistDetails(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavorites(): Promise<Array<Song>> {
        if (this.processError) {
            try {
    ...
    async searchSongs(arg0: string): Promise<string> {
        if (this.processError) {
            try {
